import { Body, ClassSerializerInterceptor, Controller, Delete, Get, HttpStatus, Logger, Param, Patch, Post, UseGuards, UseInterceptors } from '@nestjs/common';
...
export class QRCodeController {
  ...
  async update(@Body() updateQRCodeDto: UpdateQRCodeDto): Promise<QRCode> {
